...
#Extract features from C++ API calls
...
#@NOTE: Assuming that the audio format is in WAV
#Returns whether has Parkinson's or not
def predict(audioPath,modelPath):
    localJitter_list = []
...
result = predict("Speech_Assessment/audio/UnHealthy/a8.wav" , "Speech_Assessment/models/KNNModel.sav")
print("Result: " + result)